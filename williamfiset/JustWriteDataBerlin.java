...
// JustWriteDataBerlin
public class JustWriteDataBerlin {
    ...
    public JustWriteDataBerlin(double[][] coordinates) {
        this(0, coordinates);
    }

    public JustWriteDataBerlin(int start, double[][] coordinates) {
    ...
    public static void main(String[] args) {
        try {
            ...
            int n = 50; // Choose up to 50 nodes
            ...
            String writefileName = "points50_china.txt";
            //String writefileName = "points25_berlin.txt";
