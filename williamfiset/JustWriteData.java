...
public class JustWriteData {
    ...
    public JustWriteData(double[][] distance) {
        this(0, distance); // start with 0 as start node
    }

    public JustWriteData(int start, double[][] distance) {
    ...
    public static void main(String[] args) {
        ...
        // }
        // int startNode = 0;
        // JustWriteData solver = new JustWriteData(startNode, distanceMatrix);

        // System.out.println("Tour: " + solver.getTour());
        // System.out.println("Tour cost: " + solver.getTourCost());

        // // Write coordinates to a text file to pointsSize
        String fileName = "points50_RocketFuel.txt";
